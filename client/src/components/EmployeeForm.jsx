        ...
        <form onSubmit={handleSubmit} className="space-y-6 max-w-3xl animate-fade-in">
            ...
            <div className="card p-5 sm:p-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 text-sm text-slate-700">
                    ...
                    <div>
                        ...
                        <input name="bio" defaultValue={initialData?.bio} aria-rowspan={3} className="resize-none" placeholder="Brief Description..." />
                    </div>
                </div>
            </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 text-sm text-slate-700">
                    ...
                    {isEditMode && (
                        <div>
                            ...
                            <select name="employmentStatus" required min='0' step='0.01' defaultValue={initialData?.employmentStatus}>
            ...
            <div className="flex flex-col-reverse sm:flex-row justify-end gap-3 pt-2">
                ...
                <button type="submit" disabled={loading} className="btn-primary flex items-center justify-center">
                    {loading && <Loader2Icon className="w-4 h- mr-2 animate-spin" />}
